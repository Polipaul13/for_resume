...
if __name__ == '__main__':
    ...
    # c17 = read_scheme('../../circuits/c17.txt')
    #
    # repl= scheme_alt()
    # repl.__inputs__ = ['N1', 'N2']
    # repl.__outputs__ = ['OUT']
    # repl.__elements__ = {'OUT': ('OR', ['NOTN1', 'NOTN2']), 'NOTN1': ('INV', ['N1']), 'NOTN2': ('INV', ['N2'])}
    #
    # c17.replace_elements_with_scheme(['N23'], repl)
    #
    # sch = read_scheme('../../circuits/test.txt')
    # sch_r = replicate(sch, 3)
    # v = read_scheme('../../circuits/standard_voter.txt')
    # connections = dict()
    # for inp, out in zip(v.input_labels(), sch_r.output_labels()):
    #     connections[(0, out)] = [(1, inp)]
    # outputs = [(1, 'XYZ')]
    # sch_r_v = merge_schemes([sch_r, v], connections, outputs)
    # print(sch_r)
    # print(v)
    # print(sch_r_v)
    #
    # print(sc.scheme_cmp(sch_r_v, sch))

    # mainc = read_scheme('../circuits/main_circuit.txt')
    # subckt = read_scheme('../circuits/subckt.txt')
    # subckt.__inputs__.sort()
    # subckt.__outputs__.sort()
    # rnd1 = read_scheme('../circuits/rnd1.txt')
    # rnd1.__inputs__.sort()
    # rnd1.__outputs__.sort()
    # maincn = replace_elements_with_scheme(mainc, rnd1.element_labels(), subckt)
    # print(mainc.process((1,)*36) == maincn.process((1,)*36))
    c17 = read_scheme('/home/mikhail/projects/evolution/circuits/ISCAS/c432.txt')
    print(c17.process_dicts(({None: 0},) * 36))
    from scheme.stats import k_exp
    print(k_exp(c17, capacity=1024*1024))
